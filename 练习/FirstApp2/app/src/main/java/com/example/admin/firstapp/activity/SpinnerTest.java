...
import com.example.admin.firstapp.entity.Hero;
...
public class SpinnerTest extends AppCompatActivity implements AdapterView.OnItemSelectedListener,AdapterView.OnItemClickListener {

    private Spinner spin_one;
    private Spinner spin_two;
    private Context mContext;
    //判断是否为刚进去时出发onItemSelected的标志
    ...
    private void bindViews() {
        ...
        myAdapter = new MyAdapter<Hero>(mData, R.layout.item_spin_herp) {
            @Override
